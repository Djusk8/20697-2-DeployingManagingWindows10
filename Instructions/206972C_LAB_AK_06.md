...
1. On  **LON-CL3**, in Microsoft Edge, in the Admin center, expand  **Admin centers**, and then select  **Security &amp; Compliance**.
...
21. In the **Block external sharing of PII** dialog, in **Policy settings** section, click **Edit**.
...
27. Select  **Save**, select  **Save** again and then click **Close**.
...
1. In **Security &amp; Compliance** center, in the navigation pane, expand  **Data loss prevention**, click  **Device management** and then click **Device policies** in details pane. 
