...
3. Use the  **Enterprise State Roaming** option to allow the user named **Aidan Norman** to sync settings and app data across devices. Make note of Aidan’s account, because you will need it in the next task.
