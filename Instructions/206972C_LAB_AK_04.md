...
16. In the  **20697-2C-LON-CL4** window, select **Action**, select  **Revert**, and then close the **20697-2C-LON-CL4** window.
...
14. On  **LON-CL1**, in Windows PowerShell, type:  **Set-UevConfiguration -SyncMethod None**, and then press Enter.
...
6. In the  **Devices** blade, make a note of devices that are listed in the details pane. In the navigation pane, select **Enterprise State Roaming**.

7. In the  **Devices – Enterprise State Roaming** blade, in the details pane, in the  
